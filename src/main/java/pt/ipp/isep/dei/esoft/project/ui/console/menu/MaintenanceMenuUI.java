...
//import pt.ipp.isep.dei.esoft.project.application.controller.MaintenanceReportController;
...
public class MaintenanceMenuUI implements Runnable{
  /* private final VehicleCheckupRepository checkupRepository;
    private final MaintenanceReportController maintenanceReportController;


     * Constructs a new instance of MaintenanceMenuUI.

   public MaintenanceMenuUI(VehicleCheckupRepository checkupRepository, MaintenanceReportController maintenanceReportController) {
        this.checkupRepository = checkupRepository;
        this.maintenanceReportController = maintenanceReportController;
    }
      */
    /**
