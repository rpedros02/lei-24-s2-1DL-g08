...
public class Bootstrap implements Runnable {
    ...
    private void addCollaborator() {
        ...
        JobRepository jobRepository = Repositories.getInstance().getJobRepository();
        collaboratorRepository.addCollaborator("Johnny boy", new Date(13,12,2005), new Date(12,4,1995),919919919,"email@this.app",123456789, IdDocType.CC, 123456789,new Address("no street", 12, "4000-400","no city", "no country"),new Job("Jardineiro"));
